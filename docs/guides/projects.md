...
Projects are one of Synapse's most powerful features for organizing your work. They create isolated workspaces with dedicated context, instructions, memory, and secrets - preventing context bleed between unrelated tasks or clients.
...
Synapse's **Git Projects** feature allows you to clone repositories directly into your project workspace:
...
3. Synapse will clone the repository
...
> [!NOTE]
> If the cloned repository already contains a `.a0proj/` folder with `project.json`, Synapse will merge the existing configuration with your specified title and color preferences.
...
Projects work exceptionally well with Synapse's **Tasks & Scheduling** feature:
