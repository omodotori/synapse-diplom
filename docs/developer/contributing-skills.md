# Contributing Skills to Synapse

Welcome to the Synapse Skills ecosystem! This guide will help you create, test, and share skills with the community.
...
2. **Test Semantic Recall:**
   Start Synapse and ask questions that should trigger your skill.
