...
- it is portable across Synapse, Cursor, Claude Code, or Copilot-style ecosystems
...
3. Move it into `skills/` for an Synapse contribution, or publish it in a dedicated public repository/collection.
