...
> **Purpose:** Step-by-step guide for deploying Synapse instances on VPS/dedicated servers  
...
# See Synapse documentation for all options
EOF
```
...
# Refer to Synapse documentation for all options
```
...
*This guide comes from successful Synapse deployments across DirectAdmin and standard Linux environments.*
