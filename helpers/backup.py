...
class BackupService:
    """
    Core backup and restore service for Synapse.
    ...
    def __init__(self):
        self.synapse_version = self._get_synapse_version()
        self.synapse_root = files.get_abs_path("")  # Resolved Synapse root

        # Build base paths map for pattern resolution
        self.base_paths = {
            self.synapse_root: self.synapse_root,
        }
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"synapse-backup-{timestamp[:10]}",
            "include_hidden": True,
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes Synapse project directory patterns.
        """
        # Ensure paths don't have double slashes
        agent_root = self.synapse_root.rstrip('/')
...
"""
    ...
    def _get_synapse_version(self) -> str:
        """Get current Synapse version"""
        try:
    ...
    async def _get_environment_info(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "synapse_root": files.get_abs_path(""),
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up Synapse root path with the current Synapse root path
        ...
        Args:
            ...
            backup_metadata: Backup metadata containing the original synapse_root
    ...
    async def create_backup(
        ...
        backup_name: str = "synapse-backup"
    ) -> str:
        ...
        try:
            ...
            with zipfile.ZipFile(temp_file, 'r') as zipf:
                ...
                for archive_path in archive_files:
                    ...
                    # so that patterns like "/home/rafael/synapse/data/**" can match files correctly
