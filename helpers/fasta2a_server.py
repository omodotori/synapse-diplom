...
class SynapseWorker(Worker):  # type: ignore[misc]
    """Synapse implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through Synapse."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to Synapse format
            ...
            # Process message through Synapse (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to Synapse UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                ...
                "url": "https://github.com/frdel/synapse"
            }
            ...
            self._worker = SynapseWorker(broker=broker, storage=storage)  # type: ignore[attr-defined]
