...
Communicate with Synapse via WhatsApp using a Baileys-based Node.js bridge.
...
Be careful: if you use your personal number and leave `allowed_numbers` open, other people could misuse your Synapse.
...
2. In personal-number mode, you can message your own WhatsApp number to talk to Synapse, and the agent can also handle messages that other people send to that number
