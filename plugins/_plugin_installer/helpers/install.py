...
def _download_thumbnail(thumbnail_url: str, plugin_dir: str) -> None:
    ...
    try:
        ...
        req = urllib.request.Request(thumbnail_url, headers={"User-Agent": "Synapse"})
...
def fetch_plugin_index(force: bool = False) -> dict:
    ...
    index_url = "https://github.com/synapseai/synapse-plugins/releases/download/generated-index/index.json"
    if force:
