...
class DiscoveryCardsExtension(Extension):
    ...
    async def execute(self, banners: list = [], frontend_context: dict = {}, **kwargs):
        ...
        banners.append({
            ...
            "description": "Extend Synapse with integrations, tools, and automations from the community.",
        ...
        if not telegram_config.get("bot_token"):
            banners.append({
                ...
                "description": "Chat with Synapse from Telegram wherever you are.",
        ...
        if not email_is_configured:
            banners.append({
                ...
                "type": "feature",
                "title": "Setup Email",
                "description": "Let Synapse read and send emails on your behalf.",
