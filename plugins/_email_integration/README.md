...
Communicate with Synapse through email inboxes and send replies back over SMTP.
...
- **Thread routing**
  ...
  - Email replies inside an existing Synapse thread can use `/project`, `/config`, and `/send` control commands.
...
- **Description**: Communicate with Synapse via email. Supports IMAP/Exchange inbox polling with SMTP replies.
