...
Run terminal commands and execute Python or Node.js code through Synapse using persistent shell sessions.
...
- **Prompts**
  - `prompts/` contains the response templates shown to Synapse.
