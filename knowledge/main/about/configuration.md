...
Synapse uses three configurable LLM roles:
...
- Synapse API (a0_venice) - hosted service with no API key required for basic use
...
| `synapse` | Top-level general assistant; human as superior; delegates to specialized subordinates |
