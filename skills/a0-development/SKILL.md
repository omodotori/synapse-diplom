...
This skill provides comprehensive, accurate guidance for extending and building features for Synapse. Use it when you need to:
...
│   ├── synapse/                   # Main user-facing agent
...
Synapse assembles system prompts from **named fragments** using includes and variable substitution.
...
When building features for Synapse:
