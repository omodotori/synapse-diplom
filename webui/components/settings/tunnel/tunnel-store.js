    ...
    try {
      ...
      if (data.success && data.tunnel_url) {
        ...
        if (this.tunnelLink !== data.tunnel_url) {
          this.tunnelLink = data.tunnel_url;
          localStorage.setItem("synapse_tunnel_url", data.tunnel_url);
        }
        this.linkGenerated = true;
        ...
        const storedTunnelUrl = localStorage.getItem("synapse_tunnel_url");
        ...
        if (storedTunnelUrl) {
          ...
          if (verifyData.success && verifyData.is_valid) {
            ...
            // Clear stale URL
            localStorage.removeItem("synapse_tunnel_url");
            this.tunnelLink = "";
